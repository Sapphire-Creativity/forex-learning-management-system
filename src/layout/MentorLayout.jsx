...
const SideBar = ({ isCollapsed }) => {
  ...
  const navItems = [
    { path: "/mentor", label: "Dashboard", icon: IoIosHome },
    {
      path: "/mentor/mentor-courses",
      label: "Courses",
      icon: MdLibraryBooks,
    },
    { path: "/mentor/mentor-quizzes", label: "Quizzes", icon: MdQuiz },
    {
      path: "/mentor/mentor-request",
      label: "Request",
      icon: MdSupportAgent,
    },
    {
      path: "/mentor/mentor-chatroom",
      label: "Chart Room",
      icon: IoChatbubblesOutline,
    },
    { path: "/mentor/mentor-profile", label: "Profile", icon: CgProfile },
  ];
          ...
          <div className="relative flex flex-col items-center mb-4 group">
            ...
            {!isCollapsed && (
              <div className="text-center mt-3 w-full">
                ...
                <p className="text-gray-400 text-xs mt-1 truncate">Mentor</p>
              </div>
            )}
          </div>
